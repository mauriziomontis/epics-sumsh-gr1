...
/* Generated from ../O.Common/motorcontrol.dbd */
...
int motorcontrol_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/iocadm/workspace/Magnets_full_build_01/Motor_control_1";
...
/* motorcontrol_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: motorcontrol_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(motorcontrol_registerRecordDeviceDriver(*iocshPpdbbase));
}
