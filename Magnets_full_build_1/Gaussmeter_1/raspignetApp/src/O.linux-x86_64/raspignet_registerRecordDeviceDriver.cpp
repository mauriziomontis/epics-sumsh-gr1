...
/* Generated from ../O.Common/raspignet.dbd */
...
int raspignet_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/home/iocadm/workspace/Magnets_full_build_01/Gaussmeter_1";
...
/* raspignet_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: raspignet_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(raspignet_registerRecordDeviceDriver(*iocshPpdbbase));
}
