...
/* Generated from ../O.Common/PSU_control_2.dbd */
...
int PSU_control_2_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/iocadm/workspace/Magnets_full_build_01/PSU_control_2";
...
/* PSU_control_2_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: PSU_control_2_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(PSU_control_2_registerRecordDeviceDriver(*iocshPpdbbase));
}
